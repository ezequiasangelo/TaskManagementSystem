...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Fira+Code:wght@300..700&family=Press+Start+2P&display=swap" rel="stylesheet">
...
<body>
    ...
    <header class="header">
        ...
        <p>Organize suas atividades, melhore sua produtividade e mantenha o foco no que realmente importa.</p>
    </header>
